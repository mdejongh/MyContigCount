...
MyContigCountClient <- function(url, token = NULL, flatten = TRUE, 
    ...
    ret_client_object_ref[['count_contigs']] <- function(workspace_name, contigset_id) {
        ret <- ret_client_object_ref[['json_rpc_call']]("MyContigCount.count_contigs", list(
    ...
    class(ret_client_object_ref) <- 'MyContigCountClient'
