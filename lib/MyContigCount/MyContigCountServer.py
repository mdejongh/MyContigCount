...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MyContigCount'):
...
impl_MyContigCount = MyContigCount(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'MyContigCount'
        ...
        self.rpc_service.add(impl_MyContigCount.count_contigs,
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "MyContigCount but no authentication header was passed"
                            raise err
