...
/**
 * <p>Original spec-file module name: MyContigCount</p>
 * <pre>
 * A KBase module: MyContigCount
 * This sample module contains one small method - count_contigs.
 * </pre>
 */
public class MyContigCountClient {
     ...
     */
    public MyContigCountClient(URL url) {
     ...
     * validity.
     */
    public MyContigCountClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public MyContigCountClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * @return   instance of type {@link us.kbase.mycontigcount.CountContigsResults CountContigsResults}
    ...
    public CountContigsResults countContigs(String arg1, String arg2, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<CountContigsResults> res = caller.jsonrpcCall("MyContigCount.count_contigs", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }

    /**
     * <p>Original spec-file function name: run_fba</p>
     * <pre>
